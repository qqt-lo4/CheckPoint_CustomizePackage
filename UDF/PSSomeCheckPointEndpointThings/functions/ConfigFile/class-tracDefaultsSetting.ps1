<#
.SYNOPSIS
    Class representing a single setting in Check Point trac_defaults configuration file

.DESCRIPTION
    Represents a single configuration setting from trac_defaults file with properties for:
    - name: Setting name
    - type: Setting type
    - value: Current value
    - beforelastvalue: Previous value
    - lastvalue: Last value
    - space1-space5: Whitespace/tab spacing for formatting preservation
