...
- Please select a general setup configuration file (log folders and SCCM tag) -
Description
Example           
Example Consultant
------------------------------------ 1 / 1 ------------------------------------
Please use arrows and Enter to select the configuration you want. Then it will be displayed:
Selected setup general config:
Description
Example

Then you have to select steps that will be ran before executing the final MSI:
- Please select steps to run before install -
Description
Example
Example (Reconnect to SRV-CP)
------------------- 1 / 1 -------------------
Please use arrows and Enter to select the configuration you want. Then it will be displayed:
Selected steps to run before install:
Description
Example

Then you have to select step that will be ran after executing the MSI
- Please select steps to run after install -
Description
Example
Example Consultant
------------------- 1 / 1 ------------------
Please use arrows and Enter to select the configuration you want. Then it will be displayed:
Selected steps to run after install:
Description
Example

Then please select a configuration file that contains trac.defaults properties you want to apply:
- Please select a Check Point configuration file (for trac.defaults customization) -
Name           Details
External users 
Example        Filtered cerfiticates, machine auth enabled                    
Example        Filtered cerfiticates, machine auth and always connect disabled
Example        Filtered cerfiticates, machine auth disabled
--------------------------------------- 1 / 1 --------------------------------------
Please use arrows and Enter to select the configuration you want. Then it will be displayed:
Selected Check Point configuration file:
Name    Details
Example Filtered cerfiticates, machine auth enabled
...
Do you want to change trac.defaults inside MSI?
      Yes, integrate it inside MSI 
      No, change trac.defaults after setup
...
- Please select a configuration file to customize the MSI Properties -
Description
Example (SDL Disabled)
Example (SDL Enabled)
-------------------------------- 1 / 1 -------------------------------
Please use arrows and press Enter to select a configuration file.
The option you selected will be displayed:
Selected customization for MSI file:
Description
Example (SDL Disabled)
...
- Please select custom actions to be ran after package generation -
Description
External EPS (Build runner only)
Example (Copy things that will be used during setup)
Example (Copy things, Generate runner)              
------------------------------ 1 / 1 ------------------------------
...
If you upgrade a computer, please type the uninstall password
Password :
            Ok, integrate it in PS1 launcher
